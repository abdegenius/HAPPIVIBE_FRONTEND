		...
		>
			...
			<div class="mx-auto mt-40 p-6 flex justify-center items-center">
				...
				>
                    ...
                    <p class="text-orange-400 font-semibold text-md leading-6 text-center">
                        A link to reset your password has been set to your e-mail address, check to be able to reset your happivibe password!
                    </p>
				</div>
			</div>
		</div>
