<script>
	...
	const BOOKING = async () => {
		let execute = API.get('admin/booking/' + order_id);
		return execute;
	};
	let booking = null;
	let status = '';
		...
		<div class="w-full p-4 max-w-[600px] bg-white border-2 border-gray-200 rounded-lg">
			...
			<ul class="p-4">
				<li class="py-4 border-b-2 border-gray-100 flex justify-start items-start">
					...
					<div class="">
						<b class="text-gray-800 text-md font-normal capitalize"
							>{booking.your_salutation +
								' ' +
								booking.your_firstname +
								' ' +
								booking.your_lastname}
						</b>
					</div>
				</li>
				<li class="py-4 border-b-2 border-gray-100 flex justify-start items-start">
				...
				<li class="py-4 border-b-2 border-gray-100 flex justify-start items-start">
					...
					<div class="">
						<b class="text-gray-800 text-md font-normal capitalize"
							>{booking.their_salutation +
								' ' +
								booking.their_firstname +
								' ' +
								booking.their_lastname}
						</b>
					</div>
				</li>
				<li class="py-4 border-b-2 border-gray-100 flex justify-start items-start">
				...
				<li class="py-4 border-b-2 border-gray-100 flex justify-start items-start">
					...
					<div class="">
						<b class="text-gray-800 text-md font-normal capitalize"
							>{booking.their_relationship_with_you}
						</b>
					</div>
				</li>
				<li class="py-4 border-b-2 border-gray-100 flex justify-start items-start">
				...
				<li class="py-4 border-b-2 border-gray-100 flex justify-start items-start">
					...
					<div class="">
						<b class="text-gray-800 text-md font-normal capitalize"
							>{booking.how_did_you_hear_about_happivibe}
						</b>
					</div>
				</li>
				<li class="py-4 border-b-2 border-gray-100 flex justify-start items-start">
