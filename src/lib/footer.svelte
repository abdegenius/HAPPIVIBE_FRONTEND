...
<footer class="border-t border-t-primary">
	<div class="container md:pb-0 pb-20 px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
		<a
			...
			href="/home"
		>
			<img src="/logo.png" class="w-20" alt="" />
		</a>
		<p
			class="text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4"
		>
			© {year} <span class=""> HappiVibe Services</span>
		</p>
		<span
			class="inline-flex text-gray-500 sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start space-x-5"
		>
			<a class="" href="https://www.facebook.com/Hapivibe1/"><i class="fab fa-facebook fa-xl" /></a>
			<a class="" href="https://twitter.com/Hapivibe1?s=09"><i class="fab fa-twitter fa-xl" /></a>
			<a class="" href="https://instagram.com/happivibe1?igshid=11610aiz5jx8u"
				><i class="fab fa-instagram fa-xl" /></a
			>
			<a class="" href="https://www.youtube.com/channel/UCImA1vZ3ITFr6SRW_Md-kSw"
