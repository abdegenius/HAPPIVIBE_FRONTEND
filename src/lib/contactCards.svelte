...
<section class="bg-white py-20 md:px-20 px-5 lg:py-[120px] overflow-hidden relative z-10">
	<div class="container">
					...
					<div class="flex mb-8 max-w-[370px] w-full">
                     ...
                     "
						...
						<div class="w-full space-y-2">
							...
							<a href="https://www.facebook.com/Hapivibe1/" class="text-base text-body-color block"
								><i class="fab fa-facebook fa-xl mr-2" /> HapiVibe Services</a
							>
							<a
								href="https://instagram.com/happivibe1?igshid=11610aiz5jx8u"
								class="text-base text-body-color block"
								><i class="fab fa-instagram fa-xl mr-2" /> HapiVibe1</a
							>
							<a href="https://www.facebook.com/Hapivibe1/" class="text-base text-body-color block"
								><i class="fab fa-twitter fa-xl mr-2" /> HapiVibe1</a
							>
						</div>
					</div>
					<div class="flex mb-8 max-w-[370px] w-full">
                     ...
                     "
						...
						<div class="w-full">
							...
							<p class="text-base text-body-color">+234 810 491 1815</p>
						</div>
					</div>
					<div class="flex mb-8 max-w-[370px] w-full">
						<div
                     ...
                     "
						...
						<div class="w-full">
							...
							<p class="text-base text-body-color">contact@happivibe.com</p>
						</div>
					</div>
				</div>
			</div>
